...
class DB
{
    ...
    public function __construct($options = null)
    {
        ...
        if (isset($options[ 'databaseType' ]))
        {
            $this->type = strtolower($options[ 'databaseType' ]);
        }
        ...
        else
        {
            ...
            switch ($this->type)
            {
                ...
                case 'oracle':
                    ...
                    '//' . $options[ 'server' ] . ($is_port ? ':' . $port : ':1521') . '/' . $options[ 'databaseName' ] :
    ...
    {
        return ':YdJxA_' . $this->guid++ . '_yDjXa';
    }
