...
require_once APP_PATH."Core/WxPay/lib/WxPay.Exception.php";
require_once APP_PATH."Core/WxPay/lib/WxPay.Config.php";
require_once APP_PATH."Core/WxPay/lib/WxPay.Data.php";
