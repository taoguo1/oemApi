    ...
    public function __invoke(array $record)
    {
        ...
        $record['extra'] = array_merge(
            ...
            array(
                ...
                'software'          => $this->serverData['SERVER_SOFTWARE'],
                'request_time'      => $this->serverData['REQUEST_TIME'],
                'http_accept'       => $this->serverData['HTTP_ACCEPT'],
                'http_connection'   => $this->serverData['HTTP_CONNECTION'],
                'http_host'         => $this->serverData['HTTP_HOST'],
