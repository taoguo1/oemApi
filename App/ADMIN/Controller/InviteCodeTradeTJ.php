...
class InviteCodeTradeTJ extends Controller
{
    public function index()
    {
        ...
        if(!empty($month)){
            ...
            $daystart=strtotime($year."-".$month."-1"." 00:00:00");
            $dayend=strtotime($year."-".$month."-".Lib::getMonthLastDay($year,$month)." 23:59:59");
            ...
            $daystart=strtotime($year."-1-1"." 00:00:00");
            $dayend=strtotime($year."-12-31"." 23:59:59");
            $condition .= "  AND (
                                `create_time` BETWEEN ".$daystart."
                                AND ".$dayend."
                            )";
