<div class="pageContent">
	<form method="post" action="<?php echo \Core\Lib::getUrl('MyFirstNews','add','act=add');?>" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
			...
			<div class="unit">
				<table cellpadding="0" cellspacing="0">
					<tr>
						<td>
							<label>图片地址：</label>
							<input type="text" id="MyFirstNews" placeholder="点击上传图片" style="width:280px;" name="img_url" onclick="upload_file('<?php echo \Core\Lib::getUrl('upload','index','id=MyFirstNews&path=MyFirstNews')?>')" />
