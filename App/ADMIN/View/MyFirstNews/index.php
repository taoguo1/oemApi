...
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="<?=\Core\Lib::getUrl('MyFirstNews')?>" method="post">
		<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<li><a class="add" width="800" height="600" rel="articleAdd" title="添加轮播信息" href="<?=\Core\Lib::getUrl('MyFirstNews', 'add');?>" target="dialog"><span>添加</span></a></li>
			<li><a title="确定要删除吗？" target="ajaxTodo" href="<?=\Core\Lib::getUrl('MyFirstNews', 'del','id={id}');?>" class="delete"><span>删除</span></a></li>
			<li><a title="确实要删除这些记录吗?" target="selectedTodo" rel="ids" postType="string" href="<?=\Core\Lib::getUrl('MyFirstNews','delAll');?>" class="delete"><span>批量删除</span></a></li>
			<li><a class="edit" width="800" height="600"  title="编辑轮播信息" rel="articleEdit" href="<?=\Core\Lib::getUrl('MyFirstNews', 'edit','id={id}');?>" target="dialog"><span>编辑</span></a></li>
		</ul>
	</div>
	<table class="list" width="100%" layoutH="90">
		<thead>
			<tr>
				...
				<th align="center" orderField="img_url" class="<?=($data['orderField']=='img_url')?$data['orderDirection']:'';?>">图片</th>
				...
				<th align="center" orderField="content" class="<?=($data['orderField']=='content')?$data['orderDirection']:'';?>">内容</th>
		...
		<?php foreach ($data['list'] as $k=>$v){?>
			<tr target="id" rel="<?=$v['id']?>">
                ...
                <img width="60" height="60" src="<?=OSS_ENDDOMAIN.'/'.$v['img_url']?>" style="margin:5px 0;">
