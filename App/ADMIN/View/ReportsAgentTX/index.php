...
<div class="pageHeader">
    <form rel="pagerForm" onsubmit="return navTabSearch(this);" action="<?=\Core\Lib::getUrl('ReportsAgentTX','index')?>" method="post">
        <div class="searchBar">
            <table class="searchContent">
                <tr>

                        <td class="agenttxtypeclick">
                    ...
                    <td class="tdcombox agenttxnummonth" <?php if(\Core\Lib::request('type')!='month'){?> style="display:none;"<?php }?> >
...
<div class="pageContent">
 ...
 <!-- 为ECharts准备一个具备大小（宽高）的Dom -->
    <div id="agenttxmain" style="width: 90%;height:500px; margin-top:80px;"></div>
    <script type="text/javascript">
        // 基于准备好的dom，初始化echarts实例
        var myChart = echarts.init(document.getElementById('agenttxmain'));
   ...
   <script type="text/javascript">
   $(".agenttxtypeclick").click(function(){
	   
	    var val=$(this).find('input:radio[name="type"]:checked').val();
		if(val=="month"){
			$(".agenttxnummonth").show();
		}else{
			$(".agenttxnummonth").hide();
		}
   })
   </script>
