<div class="pageContent">
	<form method="post" action="<?php echo \Core\Lib::getUrl('ArticleCategory','add','act=add');?>" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
