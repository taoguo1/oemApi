...
<div class="pageHeader">
    <form rel="pagerForm" onsubmit="return navTabSearch(this);" action="<?=\Core\Lib::getUrl('UserWT','index')?>" method="post">
        <div class="searchBar">
            <table class="searchContent">
                <tr>

                    <td class="typeclickWT">
                    ...
                    <td class="tdcombox nummonthWT" <?php if(\Core\Lib::request('type')!='month'){?> style="display:none;"<?php }?>">
...
<div class="pageContent">
    ...
    <div id="WT_main" style="width: 90%;height:500px; margin-top:80px;"></div>
    <script type="text/javascript">
        // 基于准备好的dom，初始化echarts实例
        var myChart = echarts.init(document.getElementById('WT_main'));
