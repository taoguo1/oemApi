...
<div class="pageContent">
	<form method="post" action="<?php echo \Core\Lib::getUrl('Article','add','cid='.intval($cid).'&act=add');?>" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
			...
			<div class="unit">
				<table cellpadding="0" cellspacing="0">
					<tr>
						<td>
							<label>图片：</label>
							<input type="text" id="article_pic" placeholder="点击上传图片" style="width:600px;" name="pic" onclick="upload_file('<?php echo \Core\Lib::getUrl('upload','index','id=article_pic&path=article')?>')" />
