<div class="pageContent">
	<form method="post" action="<?=\Core\Lib::getUrl('Product','edit','id='.$list['id'].'&act=edit');?>" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
		<div class="pageFormContent" layoutH="56">
			...
			<div class="unit">
				<dl>
					<dt>发布时间：</dt>
					<dd>
						<input type="text" name="add_time" dateFmt="yyyy-MM-dd HH:mm:ss" readonly class="required date" value="<?php echo \Core\Lib::uDate("Y-m-d G:i:s",$list['create_time']);?>" />
					</dd>
				</dl>
			</div>
			<div class="unit nowrap">
