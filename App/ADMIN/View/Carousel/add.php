<div class="pageContent">
	<form method="post" action="<?php echo \Core\Lib::getUrl('Carousel','add','act=add');?>" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
		<div class="pageFormContent" layoutH="56">
			...
			<div class="unit">
				<table cellpadding="0" cellspacing="0">
					<tr>
						<td>
							<label>图片地址：</label>
							<input type="text" id="ad_link" placeholder="点击上传图片" style="width:280px;" name="ad_link" onclick="upload_file('<?php echo \Core\Lib::getUrl('upload','index','id=ad_link&path=ad_link')?>')" />
			...
			<div class="unit">
                <dl>
                    <dt>外部链接：</dt>
                    <dd>  
                        <input type="text" style="width:220px;" name="herf"  value="" placeholder="请输入链接，选为外部时填写" />
                    </dd>
                </dl>
            </div>
			<div class="unit">
