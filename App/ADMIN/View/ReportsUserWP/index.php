...
<div class="pageHeader">
    <form rel="pagerForm" onsubmit="return navTabSearch(this);" action="<?=\Core\Lib::getUrl('ReportsUserWP','index')?>" method="post">
        <div class="searchBar">
            <table class="searchContent">
                <tr>
                    ...
                    <?php }?>
                    <td>
                        <input size=25 name='keyword' type='text' alt='输入会员手机号' value="<?=$phone?>">
                    </td>
                    <td>
                        <label>选择会员：</label>
...
<div class="pageContent">
    ...
    if(\Core\Lib::request('month')){
        ...
        <table class="list" width="100%" layoutH="85">
            ...
            for($j = 1;$j <= \Core\Lib::getMonthLastDay($year,\Core\Lib::request('month'));$j++){
                ...
                <tr target="id" rel="<?=$j?>">
                    ...
                    <td align="center"><?=\Core\Lib::formatMoney($data['day'][$j]['sum'],2)?></td>
                    <?php
                    for($i = 0;$i <= 23;$i++){
                        ?>
                        <td align="center">
            ...
            <tr target="id" rel="<?=$j?>">
                ...
                <td align="center"><?=\Core\Lib::formatMoney($data['day']['sumday'],2);?></td>
                <?php for($i = 0;$i <= 23;$i++){ ?>
                    <td align="center"><?php
        ...
        <div class="panelBar">
            <div class="pages">
                <span>合计：<?php echo \Core\Lib::formatMoney($data['day']['sumday'],2); ?></span>
            </div>
        </div>
        <?php
    }else{
