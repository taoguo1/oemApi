<div class="pageContent">
	<form method="post" action="<?php echo \Core\Lib::getUrl('PlanList','edit','id='.$list['id'].'&act=edit');?>" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
