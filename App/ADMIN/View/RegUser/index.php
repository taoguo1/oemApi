...
<div class="pageHeader">
    <form rel="pagerForm" onsubmit="return navTabSearch(this);" action="<?=\Core\Lib::getUrl('RegUser','index')?>" method="post">
        <div class="searchBar">
            <table class="searchContent">
                <tr>

                        <td class="usertypeclick">
                    ...
                    <td class="tdcombox usernummonth" <?php if(\Core\Lib::request('type')!='month'){?> style="display:none;"<?php }?>>
...
<div class="pageContent">
 ...
 <!-- 为ECharts准备一个具备大小（宽高）的Dom -->
    <div id="usermain" style="width: 90%;height:500px; margin-top:80px;"></div>
