...
<div class="pageHeader">
    <form rel="pagerForm" onsubmit="return navTabSearch(this);" action="<?=\Core\Lib::getUrl('ReportsUserCP','index')?>" method="post">
        <div class="searchBar">
            <table class="searchContent">
                <tr>
                    ...
                    <?php }?>
                    <td>
                        <input size=25 name='keyword' type='text' alt='输入会员手机号'>
                    </td>
