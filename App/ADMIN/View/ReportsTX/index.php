...
<div class="pageHeader">
    <form rel="pagerForm" onsubmit="return navTabSearch(this);" action="<?=\Core\Lib::getUrl('ReportsTX','index')?>" method="post">
        <div class="searchBar">
            <table class="searchContent">
                <tr>

                    <td class="typeclickTX">
                    ...
                    <td class="tdcombox nummonthTX" <?php if(\Core\Lib::request('type')!='month'){?> style="display:none;"<?php }?>>
...
<div class="pageContent">
    ...
    <div id="ReportsTX_main" style="width: 90%;height:500px; margin-top:80px;"></div>
    <script type="text/javascript">
        // 基于准备好的dom，初始化echarts实例
        var myChart = echarts.init(document.getElementById('ReportsTX_main'));
